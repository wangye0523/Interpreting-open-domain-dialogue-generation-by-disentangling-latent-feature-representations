...
parser.add_argument('--result_path', dest='result_path', default='log_beta/5', type=str, help='测试结果位置')
...
parser.add_argument('--log_path', dest='log_path', default='log_beta/5', type=str, help='记录模型位置')
...
parser.add_argument('--model_path', dest='model_path', default='log_beta/5/model/030000001056480.model', type=str, help='载入模型位置')  #
...
def compute_loss(outputs, labels, masks, global_step,mu1,sigma1,mu2,sigma2):
    ...
    # 损失
    loss = nll_loss + kld_weight * kld_loss + 0.5 * kld_loss2
